...
public class WordSpliter {
	...
	public static List<String> split(String sentense, boolean isNature) {
		...
		while (st.hasMoreTokens()) {
			...
			for (String str2 : tempWordList) {
				...
				if (isNature) {
					if (NatureStopwords.isStopword(str2)) {
						continue;
					}
				} else {
					if (ProgramingStopwords.isStopword(str2)) {
						continue;
					}
				}
	...
	public static void main(String[] args) {
		...
		// }
		String str = "does";
		List<String> tempWordList = WordSpliter.split(str, true);
